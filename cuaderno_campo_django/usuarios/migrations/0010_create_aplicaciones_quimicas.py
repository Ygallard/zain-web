...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.RunSQL(
            ...
            CREATE INDEX IF NOT EXISTS idx_aplicaciones_quimicas_cuartel
                ON aplicaciones_quimicas(cuartel_id);
            CREATE INDEX IF NOT EXISTS idx_aplicaciones_quimicas_fecha
                ON aplicaciones_quimicas(fecha_aplicacion);
            """,
            reverse_sql="""
